...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = OtherEvents.class, name = "ACCOUNT_POSITION_UPDATE"),
        @JsonSubTypes.Type(value = OtherEvents.class, name = "BALANCE_UPDATE"),
        @JsonSubTypes.Type(value = OtherEvents.class, name = "ORDER_TRADE_UPDATE"),
